...
[UPDATE!]: Arto also suggested that to see what happens if we remove the two most extreme cases on the top left corner, where the two data points have very high API score and a high negative FBI score:
