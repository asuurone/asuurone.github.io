...
So, encountering disagreeable content receives negative numbers in according to how commonly they are encountered, and then we will just sum AC and AD together, where\_
...
So, it looks like it would be a good idea to re-formulate this item a bit differently, so that it captures antagonism more clearly.
